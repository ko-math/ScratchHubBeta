...
運営は，本条に基づき当社が行った行為によりユーザーに生じた損害について，一切の責任を負いません。
`,
`第8条（退会）
...
前項ただし書に定める場合であっても，運営は，運営の過失（重過失を除きます。）による不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害（運営またはユーザーが損害発生につき予見し，または予見し得た場合を含みます。）について一切の責任を負いません。
`,
`第10条（サービス内容の変更等）
